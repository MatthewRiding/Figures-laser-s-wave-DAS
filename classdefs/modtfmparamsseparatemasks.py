class TFMParamsSepMasks:
    def __init__(self,
                 ...
                 mask_tf=False,
                 mask_angle_deg=None,
                 mask_behaviour_string_gen=None,
                 mask_behaviour_string_det=None
                 ):
        ...
        self.mask_behaviour_string_gen = mask_behaviour_string_gen
        self.mask_behaviour_string_det = mask_behaviour_string_det
